/**
 * Calculate running average score combining previous score with new score
 * Uses weighted average: (previous_score * count) + new_score / (count + 1)
...
/**
 * Update profile with new scores after a post/comment
 * @param {Object} profile - User profile document
 * @param {number} toxicity - New toxicity score (1-100)
 * @param {number} bias - New bias score (1-100)
 * @returns {Object} - Updated profile with new scores
 */
