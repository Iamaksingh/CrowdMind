...
import { createThread, getThreads, getThreadById, deleteThread, addComment, getThreadByUser, like_unlike, getCommentAnalysis } from '../controllers/threadController.js';
...
router.get('/:threadId/comments/:commentIndex/analysis', getCommentAnalysis);
